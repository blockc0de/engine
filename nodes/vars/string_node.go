...
var (
	stringNodeDefinition       = []interface{}{attributes.NodeDefinition{NodeName: "StringNode", FriendlyName: "String", NodeType: attributes.NodeTypeEnumVariable, GroupName: "Base Variable"}}
