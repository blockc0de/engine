...
var (
	decimalNodeDefinition       = []interface{}{attributes.NodeDefinition{NodeName: "DecimalNode", FriendlyName: "Decimal", NodeType: attributes.NodeTypeEnumVariable, GroupName: "Variable", BlockLimitPerGraph: -1}}
