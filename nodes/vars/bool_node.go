...
var (
	boolNodeDefinition       = []interface{}{attributes.NodeDefinition{NodeName: "BoolNode", FriendlyName: "Boolean", NodeType: attributes.NodeTypeEnumVariable, GroupName: "Base Variable"}}
