...
var (
	setVariableNodeDefinition       = []interface{}{attributes.NodeDefinition{NodeName: "SetVariable", FriendlyName: "Set variable", NodeType: attributes.NodeTypeEnumFunction, GroupName: "Base Variable"}}
