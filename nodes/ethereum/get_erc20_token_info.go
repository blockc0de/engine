...
var (
	...
	getErc20TokenInfoNodeDefinition       = []interface{}{attributes.NodeDefinition{NodeName: "GetERC20TokenInformationsNode", FriendlyName: "Get ERC20 Informations", NodeType: attributes.NodeTypeEnumFunction, GroupName: "Blockchain.Ethereum", BlockLimitPerGraph: -1}}
